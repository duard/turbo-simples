export const PLANS = [
  {
    ...
    cta: {
      text: "Start for free",
      href: "https://app.simples.co/register",
    ...
    features: [
      ...
      },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://simples.co/docs/api-reference/introduction",
        },
      },
    ],
  },
    ...
    features: [
      ...
      { text: "Basic support", footnote: "Basic email support." },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://simples.co/help/article/how-to-redirect-root-domain",
        },
      },
      {
    ...
    features: [
      ...
      { text: "Elevated support", footnote: "Email and chat support." },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://simples.co/help/article/custom-qr-codes",
        },
      },
      {
