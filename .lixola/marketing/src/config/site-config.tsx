...
export const siteConfig = {
  global: {
    url: "https://simplesempresa.cc",
    name: "Simples Empresa",
    logo: "/images/logo.png",
    title: "Simples Empresa | Gerenciamento para empresas",
    description:
      "Simples Empresa your project with this monorepo starter. It comes with Next.js, Tailwind CSS, Shadcn-ui, Server components, and more.",
  ...
  homePage: {
    ...
    cta: {
      ...
      subheadline: "Simples Empresa is open source and available on GitHub",
      cta: {
        label: "GitHub Repo",
        href: "https://github.com/mehdibha/turbocharger",
      },
    ...
    pricingPlans: [
      {
        ...
        features: [
          ...
          "Optimized SEO",
          "Has 'Built with Simples Empresa' branding",
        ],
      },
      {
        featured: true,
        ...
        features: [
          "Everything in Free.",
          "Basic analytics",
          "Remove 'Built with Simples Empresa' branding",
        ],
      },
      {
        name: "Entreprise",
    ...
    faq: [
      {
        ...
        answer:
          "Simples Empresa is a monorepo starter that comes with Next.js, Tailwind CSS, Shadcn-ui, Server components, and more. It's a great way to start your next project.",
      },
      {
        question: "How do I create a website with Simples Empresa?",
        answer:
          "You can create a website with Simples Empresa by following the documentation.",
      },
      {
        question: "How much does Simples Empresa cost?",
        answer: "It's free to use Simples Empresa",
      },
      {
        question: "Can I use Simples Empresa for free?",
        answer: "Yes, you can use Simples Empresa for free.",
      },
    ],
    cta: {
      headline: "Proudly **open-source**",
      subheadline: "Simples Empresa is open source and available on GitHub",
      cta: { label: "Star on GitHub", href: "https://github.com/simplesempresa" },
    },
  },
  blogPage: {
    headline: "Blog",
    subheadline: "Learn more about Simples Empresa and write your posts with MDX.",
  },
};
